...
function cacheElements() {
     ...
     console.log("Start Game Button Element:", elements.btnStartGame);
...
function setupEventListeners() {
    ...
    // Check if btnStartGame exists before adding listener
    if (elements.btnStartGame) {
        elements.btnStartGame.addEventListener('click', startGame);
        console.log("Click listener added to btnStartGame.");
    } else {
        console.error("btnStartGame element not found, cannot add click listener.");
    }

    // ... (listeners for gatherMotes, channelMana, etc.) ...
...
function switchTab(tabId) {
 ...
 function handleKeyPress(event) {
    // ... (ignore input fields, modals checks) ...

    const key = event.key.toUpperCase();
    switch(key) {
        case 'ENTER':
            if (!gameState.started && elements.btnStartGame) { // Check elements.btnStartGame here too
                console.log("Enter key pressed, attempting to click btnStartGame...");
                elements.btnStartGame.click();
            } else if (!elements.btnStartGame) {
                 console.log("Enter key pressed, but btnStartGame element not found.");
            }
                         break;
        // ... other cases ...
    }
